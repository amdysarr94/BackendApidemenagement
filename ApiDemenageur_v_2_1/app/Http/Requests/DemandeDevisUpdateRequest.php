...
class DemandeDevisUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'adresse_actuelle' => 'sometimes|string|max:300',
            'nouvelle_adresse' => 'sometimes|string|max:300',
            'informations_bagages'=> 'sometimes|string|max:900',
            'date_demenagement' => 'required|date'
        ];
    }
    public function messages(){
        return[
            'nom_entreprise.sometimes'=>"Le nom de l'entreprise doit être fourni",
            ...
            'nom_client.sometimes'=>"Le nom du client doit être fourni",
            ...
            'adresse_actuelle.sometimes'=>"L'adresse actuelle du client doit être fourni",
            ...
            'nouvelle_adresse.sometimes'=>"La nouvelle adresse du client doit être fourni",
            ...
            'informations_bagages.sometimes'=>"Les informations sur les bagages du client doit être fourni",
